...
///    ORB_SLAM2::System SLAM(str_vocab,str_settings,ORB_SLAM2::System::RGBD,true);
    ORB_SLAM2::System SLAM(str_vocab,str_settings,ORB_SLAM2::System::MONOCULAR,true);
    ...
    while(1)
    {
        ...
        imRGB = cv::imread("/home/isl-server/ashish/datasets/generalautonomy/small_any_pick/data_20240817_185636/right_gripper/RGBD/rgb_" +idx.str() +".png");
        imD = cv::imread("/home/isl-server/ashish/datasets/generalautonomy/small_any_pick/data_20240817_185636/right_gripper/RGBD/depth_" +idx.str() +".png");
